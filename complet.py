...
for F2_base in [1.4]:
    ...
    TIME_SIMU = 100.0       # durée de la simulation (minutes)
    ...
    k_PDE = 400  # Taux dégradation cAMP par PDE (min^-1)
    ...
    # F2_base = 1.3     # taux de réactivation de base dont dépend r_T la fraction de récepteurs actifs
